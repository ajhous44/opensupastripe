...
export const AnimatedBeam: React.FC<AnimatedBeamProps> = ({
  ...
  const animationDuration = duration ?? fallbackDuration
  ...
  useEffect(() => {
    ...
    // Initial update with multiple attempts to ensure elements are fully rendered
    const timeoutId = setTimeout(updatePath, 50)
    const timeoutId2 = setTimeout(updatePath, 100)
    const timeoutId3 = setTimeout(updatePath, 200)
